...
/**
 * GetUpsellConfigurationsForProjectAdmin200ResponseInnerItemsInner Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class GetUpsellConfigurationsForProjectAdmin200ResponseInnerItemsInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'get_upsell_configurations_for_project_admin_200_response_inner_items_inner';
    ...
    protected static $openAPITypes = [
        ...
        'unit_type' => 'string',
        'unit_items' => '\OpenAPI\Client\Model\GetUpsellConfigurationsForProjectAdmin200ResponseInnerItemsInnerUnitItemsInner[]'
    ];
    ...
    */
    ...
    public function setSku($sku)
    {
        ...
        if ((mb_strlen($sku) > 255)) {
            throw new \InvalidArgumentException('invalid length for $sku when calling GetUpsellConfigurationsForProjectAdmin200ResponseInnerItemsInner., must be smaller than or equal to 255.');
        }
        if ((mb_strlen($sku) < 1)) {
            throw new \InvalidArgumentException('invalid length for $sku when calling GetUpsellConfigurationsForProjectAdmin200ResponseInnerItemsInner., must be bigger than or equal to 1.');
        }
        if ((!preg_match("/^[a-zA-Z0-9_\\-–.]*$/", ObjectSerializer::toString($sku)))) {
            throw new \InvalidArgumentException("invalid value for \$sku when calling GetUpsellConfigurationsForProjectAdmin200ResponseInnerItemsInner., must conform to the pattern /^[a-zA-Z0-9_\\-–.]*$/.");
        }
     ...
     * Gets unit_items
     *
     * @return \OpenAPI\Client\Model\GetUpsellConfigurationsForProjectAdmin200ResponseInnerItemsInnerUnitItemsInner[]|null
     */
     ...
     * Sets unit_items
     *
     * @param \OpenAPI\Client\Model\GetUpsellConfigurationsForProjectAdmin200ResponseInnerItemsInnerUnitItemsInner[]|null $unit_items Game keys for different DRMs.
     *
     * @return self
     */
