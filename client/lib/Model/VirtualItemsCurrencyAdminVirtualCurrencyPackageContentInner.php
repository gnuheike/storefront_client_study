<?php
/**
 * VirtualItemsCurrencyAdminVirtualCurrencyPackageContentInner
 *
 * PHP version 8.1
 *
 * @category Class
...
/**
 * VirtualItemsCurrencyAdminVirtualCurrencyPackageContentInner Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class VirtualItemsCurrencyAdminVirtualCurrencyPackageContentInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Virtual_Items_Currency_admin_virtual_currency_package_content_inner';
    ...
    */
    ...
    public function setSku($sku)
    {
        ...
        if ((mb_strlen($sku) > 255)) {
            throw new \InvalidArgumentException('invalid length for $sku when calling VirtualItemsCurrencyAdminVirtualCurrencyPackageContentInner., must be smaller than or equal to 255.');
        }
        if ((mb_strlen($sku) < 1)) {
            throw new \InvalidArgumentException('invalid length for $sku when calling VirtualItemsCurrencyAdminVirtualCurrencyPackageContentInner., must be bigger than or equal to 1.');
        }
        if ((!preg_match("/^[a-zA-Z0-9_\\-–.]*$/", ObjectSerializer::toString($sku)))) {
            throw new \InvalidArgumentException("invalid value for \$sku when calling VirtualItemsCurrencyAdminVirtualCurrencyPackageContentInner., must conform to the pattern /^[a-zA-Z0-9_\\-–.]*$/.");
        }
