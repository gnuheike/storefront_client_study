...
/**
 * UserAttributeConditionsResponseDateInner Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class UserAttributeConditionsResponseDateInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'user_attribute_conditions_response_date_inner';
    ...
    protected static $openAPITypes = [
        'attribute' => 'string',
        'type' => '\OpenAPI\Client\Model\UserAttributeConditionsPropertiesTypeDate',
    ...
    */
    ...
    public function setAttribute($attribute)
    {
        ...
        if ((mb_strlen($attribute) > 255)) {
            throw new \InvalidArgumentException('invalid length for $attribute when calling UserAttributeConditionsResponseDateInner., must be smaller than or equal to 255.');
        }
        if ((mb_strlen($attribute) < 1)) {
            throw new \InvalidArgumentException('invalid length for $attribute when calling UserAttributeConditionsResponseDateInner., must be bigger than or equal to 1.');
        }
        if ((!preg_match("/^[-_.\\d\\w]+$/", ObjectSerializer::toString($attribute)))) {
            throw new \InvalidArgumentException("invalid value for \$attribute when calling UserAttributeConditionsResponseDateInner., must conform to the pattern /^[-_.\\d\\w]+$/.");
        }
     ...
     * Gets type
     *
     * @return \OpenAPI\Client\Model\UserAttributeConditionsPropertiesTypeDate|null
     */
     ...
     * Sets type
     *
     * @param \OpenAPI\Client\Model\UserAttributeConditionsPropertiesTypeDate|null $type type
     *
     * @return self
     */
    ...
    public function setValue($value)
    {
        ...
        if ((mb_strlen($value) > 255)) {
            throw new \InvalidArgumentException('invalid length for $value when calling UserAttributeConditionsResponseDateInner., must be smaller than or equal to 255.');
        }
