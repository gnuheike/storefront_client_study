...
/**
 * CreateOrderWithItemRequest Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class CreateOrderWithItemRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'create_order_with_item_request';
    ...
    */
    ...
    public function setQuantity($quantity)
    {
        ...
        if (($quantity < 1)) {
            throw new \InvalidArgumentException('invalid value for $quantity when calling CreateOrderWithItemRequest., must be bigger than or equal to 1.');
        }
     ...
     * Sets promo_code
     *
     * @param string|null $promo_code Redeems a code of a promo code promotion with payment.
     *
     * @return self
     */
