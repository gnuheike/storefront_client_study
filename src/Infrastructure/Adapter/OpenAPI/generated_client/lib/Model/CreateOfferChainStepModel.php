...
/**
 * CreateOfferChainStepModel Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class CreateOfferChainStepModel implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'create-offer-chain-step-model';
    ...
    */
    ...
    public function setStepNumber($step_number)
    {
        ...
        if (($step_number < 1)) {
            throw new \InvalidArgumentException('invalid value for $step_number when calling CreateOfferChainStepModel., must be bigger than or equal to 1.');
        }
    ...
    public function setItems($items)
    {
        ...
        if ((count($items) < 1)) {
            throw new \InvalidArgumentException('invalid length for $items when calling CreateOfferChainStepModel., number of items must be greater than or equal to 1.');
        }
