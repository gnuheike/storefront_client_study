...
/**
 * UserAttributeConditionsDateInner Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class UserAttributeConditionsDateInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'user_attribute_conditions_date_inner';
    ...
    */
    ...
    public function setAttribute($attribute)
    {
        ...
        if ((mb_strlen($attribute) > 255)) {
            throw new \InvalidArgumentException('invalid length for $attribute when calling UserAttributeConditionsDateInner., must be smaller than or equal to 255.');
        }
        if ((mb_strlen($attribute) < 1)) {
            throw new \InvalidArgumentException('invalid length for $attribute when calling UserAttributeConditionsDateInner., must be bigger than or equal to 1.');
        }
        if ((!preg_match("/^[-_.\\d\\w]+$/", ObjectSerializer::toString($attribute)))) {
            throw new \InvalidArgumentException("invalid value for \$attribute when calling UserAttributeConditionsDateInner., must conform to the pattern /^[-_.\\d\\w]+$/.");
        }
     ...
     * Gets type
     *
     * @return \OpenAPI\Client\Model\UserAttributeConditionsPropertiesTypeDate
     */
     ...
     * Sets type
     *
     * @param \OpenAPI\Client\Model\UserAttributeConditionsPropertiesTypeDate $type type
     *
     * @return self
     */
    ...
    public function setValue($value)
    {
        ...
        if ((mb_strlen($value) > 255)) {
            throw new \InvalidArgumentException('invalid length for $value when calling UserAttributeConditionsDateInner., must be smaller than or equal to 255.');
        }
