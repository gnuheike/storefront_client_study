...
/**
 * InlineObject68ItemsInner Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class InlineObject68ItemsInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'inline_object_68_items_inner';
    ...
    protected static $openAPITypes = [
        'sku' => 'string',
        'name' => 'string',
        'groups' => '\OpenAPI\Client\Model\InlineObject68ItemsInnerGroupsInner[]',
        'attributes' => '\OpenAPI\Client\Model\VirtualItemsCurrencyClientAttributesInner[]',
        'type' => 'string',
        'description' => 'string',
        'image_url' => 'string',
        'is_free' => 'bool',
        'price' => '\OpenAPI\Client\Model\InlineObject68ItemsInnerPrice',
        'virtual_prices' => '\OpenAPI\Client\Model\InlineObject68ItemsInnerVirtualPricesInner[]',
        'can_be_bought' => 'bool',
    ...
    */
     ...
     * Gets groups
     *
     * @return \OpenAPI\Client\Model\InlineObject68ItemsInnerGroupsInner[]|null
     */
     ...
     * Sets groups
     *
     * @param \OpenAPI\Client\Model\InlineObject68ItemsInnerGroupsInner[]|null $groups Groups the item belongs to.
     *
     * @return self
     */
     ...
     * Sets type
     *
     * @param string|null $type Type of item: `consumable`/`expiration`/`permanent`/`lootboxes`/`physical`.
     *
     * @return self
     */
     ...
     * Gets price
     *
     * @return \OpenAPI\Client\Model\InlineObject68ItemsInnerPrice|null
     */
     ...
     * Sets price
     *
     * @param \OpenAPI\Client\Model\InlineObject68ItemsInnerPrice|null $price price
     *
     * @return self
     */
     ...
     * Gets virtual_prices
     *
     * @return \OpenAPI\Client\Model\InlineObject68ItemsInnerVirtualPricesInner[]|null
     */
     ...
     * Sets virtual_prices
     *
     * @param \OpenAPI\Client\Model\InlineObject68ItemsInnerVirtualPricesInner[]|null $virtual_prices Virtual prices.
     *
     * @return self
     */
