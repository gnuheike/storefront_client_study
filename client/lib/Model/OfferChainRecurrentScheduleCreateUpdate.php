...
/**
 * OfferChainRecurrentScheduleCreateUpdate Class Doc Comment
 *
 * @category Class
 ...
 */
class OfferChainRecurrentScheduleCreateUpdate implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'offer_chain_recurrent_schedule_create_update';
    ...
    */
     ...
     * Gets interval_type
     *
     * @return \OpenAPI\Client\Model\OfferChainIntervalTypeMonthly
     */
     ...
     * Sets interval_type
     *
     * @param \OpenAPI\Client\Model\OfferChainIntervalTypeMonthly $interval_type interval_type
     *
     * @return self
     */
    ...
    public function setDayOfWeek($day_of_week)
    {
        ...
        if (($day_of_week > 7)) {
            throw new \InvalidArgumentException('invalid value for $day_of_week when calling OfferChainRecurrentScheduleCreateUpdate., must be smaller than or equal to 7.');
        }
        if (($day_of_week < 1)) {
            throw new \InvalidArgumentException('invalid value for $day_of_week when calling OfferChainRecurrentScheduleCreateUpdate., must be bigger than or equal to 1.');
        }
    ...
    public function setTime($time)
    {
        ...
        if ((!preg_match("/((0[0-9]|1[0-9]|2[0-3]):00:00)(\\+|-)(0[0-9]|1[0-9]|2[0-3]):([0-5][0-9])/", ObjectSerializer::toString($time)))) {
            throw new \InvalidArgumentException("invalid value for \$time when calling OfferChainRecurrentScheduleCreateUpdate., must conform to the pattern /((0[0-9]|1[0-9]|2[0-3]):00:00)(\\+|-)(0[0-9]|1[0-9]|2[0-3]):([0-5][0-9])/.");
        }
     ...
     * Sets day_of_month
     *
     * @param int $day_of_month The day of the month when the offer chain is reset. If a month has fewer days than the specified day, the reset will occur on the last day of the month.
     *
     * @return self
     */
    public function setDayOfMonth($day_of_month)
    {
        ...
        if (($day_of_month > 31)) {
            throw new \InvalidArgumentException('invalid value for $day_of_month when calling OfferChainRecurrentScheduleCreateUpdate., must be smaller than or equal to 31.');
        }
        if (($day_of_month < 1)) {
            throw new \InvalidArgumentException('invalid value for $day_of_month when calling OfferChainRecurrentScheduleCreateUpdate., must be bigger than or equal to 1.');
        }
