<?php
/**
 * AdminCreateGameRequestMediaListInner
 *
 * PHP version 8.1
 *
 * @category Class
...
/**
 * AdminCreateGameRequestMediaListInner Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class AdminCreateGameRequestMediaListInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'admin_create_game_request_media_list_inner';
    ...
    */
     ...
     * Sets type
     *
     * @param string|null $type Type of media: `image`/`video`.
     *
     * @return self
     */
     ...
     * Sets url
     *
     * @param string|null $url Resource file.
     *
     * @return self
     */
