...
/**
 * AdminGetRewardChainItemClanFullModel Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class AdminGetRewardChainItemClanFullModel implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'admin-get-reward-chain-item-clan-full-model';
    ...
    protected static $openAPITypes = [
        ...
        'date_end' => '\DateTime',
        'is_enabled' => 'bool',
        'value_point' => '\OpenAPI\Client\Model\AdminGetRewardChainItemClanFullModelAllOfValuePoint',
        'steps' => '\OpenAPI\Client\Model\RewardStepShort[]',
    ...
    */
     ...
     * Gets value_point
     *
     * @return \OpenAPI\Client\Model\AdminGetRewardChainItemClanFullModelAllOfValuePoint|null
     */
     ...
     * Sets value_point
     *
     * @param \OpenAPI\Client\Model\AdminGetRewardChainItemClanFullModelAllOfValuePoint|null $value_point value_point
     *
     * @return self
     */
     ...
     * Gets steps
     *
     * @return \OpenAPI\Client\Model\RewardStepShort[]|null
     */
     ...
     * Sets steps
     *
     * @param \OpenAPI\Client\Model\RewardStepShort[]|null $steps steps
     *
     * @return self
     */
    ...
    public function setTopContributors($top_contributors)
    {
        if (is_null($top_contributors)) {
            array_push($this->openAPINullablesSetToNull, 'top_contributors');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('top_contributors', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
