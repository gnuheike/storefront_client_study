<?php
/**
 * PromotionsPromocodeTotalLimitState
 *
 * PHP version 8.1
 *
 * @category Class
...
/**
 * PromotionsPromocodeTotalLimitState Class Doc Comment
 *
 * @category Class
 ...
 */
class PromotionsPromocodeTotalLimitState implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Promotions_promocode_total_limit_state';
    ...
    */
     ...
     * Sets available
     *
     * @param int|null $available The remaining number of times a promo code can be used.
     *
     * @return self
     */
     ...
     * Sets reserved
     *
     * @param int|null $reserved The reserved number of a promo code.
     *
     * @return self
     */
