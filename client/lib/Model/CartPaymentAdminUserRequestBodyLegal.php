<?php
/**
 * CartPaymentAdminUserRequestBodyLegal
 *
 * PHP version 8.1
 *
 * @category Class
...
/**
 * CartPaymentAdminUserRequestBodyLegal Class Doc Comment
 *
 * @category Class
 ...
 */
class CartPaymentAdminUserRequestBodyLegal implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Cart_Payment_admin_user_request_body_legal';
    ...
    */
     ...
     * Sets name
     *
     * @param string|null $name Full legal name.
     *
     * @return self
     */
     ...
     * Sets address
     *
     * @param string|null $address Full legal address.
     *
     * @return self
     */
     ...
     * Sets vat_id
     *
     * @param string|null $vat_id Individual taxpayer identifier.
     *
     * @return self
     */
     ...
     * Sets country
     *
     * @param string|null $country Country of incorporation. Two-letter uppercase country code per [ISO 3166-1 alpha-2](https://en.wikipedia.org/wiki/ISO_3166-1_alpha-2) is used.
     *
     * @return self
     */
