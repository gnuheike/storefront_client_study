...
/**
 * IntervalTypeMonthly4 Class Doc Comment
 *
 * @category Class
 ...
 */
class IntervalTypeMonthly4 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'interval_type___monthly_4';
    ...
    */
    ...
    public function setDayOfMonth($day_of_month)
    {
        ...
        if (($day_of_month > 31)) {
            throw new \InvalidArgumentException('invalid value for $day_of_month when calling IntervalTypeMonthly4., must be smaller than or equal to 31.');
        }
        if (($day_of_month < 1)) {
            throw new \InvalidArgumentException('invalid value for $day_of_month when calling IntervalTypeMonthly4., must be bigger than or equal to 1.');
        }
    ...
    public function setTime($time)
    {
        ...
        if ((!preg_match("/((0[0-9]|1[0-9]|2[0-3]):00:00)(\\+|-)(0[0-9]|1[0-9]|2[0-3]):([0-5][0-9])/", ObjectSerializer::toString($time)))) {
            throw new \InvalidArgumentException("invalid value for \$time when calling IntervalTypeMonthly4., must conform to the pattern /((0[0-9]|1[0-9]|2[0-3]):00:00)(\\+|-)(0[0-9]|1[0-9]|2[0-3]):([0-5][0-9])/.");
        }
