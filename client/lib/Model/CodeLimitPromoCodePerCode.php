...
/**
 * CodeLimitPromoCodePerCode Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class CodeLimitPromoCodePerCode implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Code_limit_promo_code_per_code';
    ...
    */
     ...
     * Sets total
     *
     * @param int|null $total The maximum number of times a promo code can be used.
     *
     * @return self
     */
     ...
     * Sets available
     *
     * @param int|null $available The remaining number of times promo code can be used.
     *
     * @return self
     */
     ...
     * Sets used
     *
     * @param int|null $used The number of times a promo code is used.
     *
     * @return self
     */
     ...
     * Sets reserved
     *
     * @param int|null $reserved The number of times a promo code is reserved.
     *
     * @return self
     */
