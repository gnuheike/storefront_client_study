<?php
/**
 * ClientRewardChainItemModelStepsInnerPrice
 *
 * PHP version 8.1
 *
 * @category Class
...
/**
 * ClientRewardChainItemModelStepsInnerPrice Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class ClientRewardChainItemModelStepsInnerPrice implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'client_reward_chain_item_model_steps_inner_price';
    ...
    */
     ...
     * Sets amount
     *
     * @param int|null $amount The number of value points that a user claim for the step.
     *
     * @return self
     */
