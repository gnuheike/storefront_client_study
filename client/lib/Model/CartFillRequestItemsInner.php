...
/**
 * CartFillRequestItemsInner Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class CartFillRequestItemsInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'cart_fill_request_items_inner';
    ...
    {
        $this->setIfExists('sku', $data ?? [], 'booster_mega_1');
        $this->setIfExists('quantity', $data ?? [], 123);
    }
