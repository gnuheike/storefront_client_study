...
/**
 * CreateBonusPromotionRequestConditionInner Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class CreateBonusPromotionRequestConditionInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'create_bonus_promotion_request_condition_inner';
    ...
    {
        $this->setIfExists('sku', $data ?? [], 'elven_sword');
    }
