<?php
/**
 * GrantEntitlementAdminRequestGame
 *
 * PHP version 8.1
 *
 * @category Class
...
/**
 * GrantEntitlementAdminRequestGame Class Doc Comment
 *
 * @category Class
 ...
 */
class GrantEntitlementAdminRequestGame implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'grant_entitlement_admin_request_game';
    ...
    */
     ...
     * Sets sku
     *
     * @param string $sku Unique key package ID.
     *
     * @return self
     */
    public function setSku($sku)
    {
        ...
        if ((mb_strlen($sku) > 255)) {
            throw new \InvalidArgumentException('invalid length for $sku when calling GrantEntitlementAdminRequestGame., must be smaller than or equal to 255.');
        }
        if ((mb_strlen($sku) < 1)) {
            throw new \InvalidArgumentException('invalid length for $sku when calling GrantEntitlementAdminRequestGame., must be bigger than or equal to 1.');
        }
        if ((!preg_match("/^[a-zA-Z0-9_\\-–.]*$/", ObjectSerializer::toString($sku)))) {
            throw new \InvalidArgumentException("invalid value for \$sku when calling GrantEntitlementAdminRequestGame., must conform to the pattern /^[a-zA-Z0-9_\\-–.]*$/.");
        }
