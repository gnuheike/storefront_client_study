...
/**
 * AddUserItemLimitRequest Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class AddUserItemLimitRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'add_user_item_limit_request';
    ...
    */
     ...
     * Sets available
     *
     * @param int $available Remaining number of items or promotion uses available to the user within the limit applied.
     *
     * @return self
     */
    public function setAvailable($available)
    {
        ...
        if (($available < 1)) {
            throw new \InvalidArgumentException('invalid value for $available when calling AddUserItemLimitRequest., must be bigger than or equal to 1.');
        }
