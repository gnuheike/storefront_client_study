...
/**
 * ItemLimitResponsePerUserRecurrentSchedule Class Doc Comment
 *
 * @category Class
 ...
 */
class ItemLimitResponsePerUserRecurrentSchedule implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'item_limit_response_per_user_recurrent_schedule';
    ...
    */
     ...
     *
     * @param int|null $reset_next_date Date and time when limits reset (Unix Timestamp).
     *
     * @return self
     */
