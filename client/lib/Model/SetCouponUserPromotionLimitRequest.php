...
/**
 * SetCouponUserPromotionLimitRequest Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class SetCouponUserPromotionLimitRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'set_coupon_user_promotion_limit_request';
    ...
    */
    ...
    public function setAvailable($available)
    {
        ...
        if (($available < 0)) {
            throw new \InvalidArgumentException('invalid value for $available when calling SetCouponUserPromotionLimitRequest., must be bigger than or equal to 0.');
        }
