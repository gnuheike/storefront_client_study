<?php
/**
 * VirtualItemsCurrencyInventoryOptionsConsumable
 *
 * PHP version 8.1
 *
 * @category Class
...
/**
 * VirtualItemsCurrencyInventoryOptionsConsumable Class Doc Comment
 *
 * @category Class
 ...
 */
class VirtualItemsCurrencyInventoryOptionsConsumable implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Virtual_Items_Currency_inventory_options_consumable';
    ...
    {
        $this->setIfExists('usages_count', $data ?? [], null);
    }
    ...
    */
    ...
    {
        return $this->container['usages_count'];
    }

    /**
     * Sets usages_count
     *
     * @param int|null $usages_count Total number of remaining uses if this is a consumable item, or `null` if this is a non-consumable item.
     *
     * @return self
     */
    public function setUsagesCount($usages_count)
    {
        if (is_null($usages_count)) {
            array_push($this->openAPINullablesSetToNull, 'usages_count');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('usages_count', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['usages_count'] = $usages_count;
