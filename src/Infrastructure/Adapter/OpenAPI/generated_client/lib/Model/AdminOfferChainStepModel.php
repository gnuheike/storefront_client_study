...
/**
 * AdminOfferChainStepModel Class Doc Comment
 *
 * @category Class
 ...
 */
class AdminOfferChainStepModel implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'admin-offer-chain-step-model';
    ...
    protected static $openAPITypes = [
        ...
        'items' => '\OpenAPI\Client\Model\AdminOfferChainItemModel[]'
    ];
    ...
    */
     ...
     * Sets step_id
     *
     * @param int|null $step_id Unique ID of the chain step.
     *
     * @return self
     */
    public function setStepId($step_id)
    {
        ...
        if (!is_null($step_id) && ($step_id < 1)) {
            throw new \InvalidArgumentException('invalid value for $step_id when calling AdminOfferChainStepModel., must be bigger than or equal to 1.');
        }
    ...
    public function setStepNumber($step_number)
    {
        ...
        if (($step_number < 1)) {
            throw new \InvalidArgumentException('invalid value for $step_number when calling AdminOfferChainStepModel., must be bigger than or equal to 1.');
        }
     ...
     * Gets items
     *
     * @return \OpenAPI\Client\Model\AdminOfferChainItemModel[]|null
     */
     ...
     * Sets items
     *
     * @param \OpenAPI\Client\Model\AdminOfferChainItemModel[]|null $items items
     *
     * @return self
     */
