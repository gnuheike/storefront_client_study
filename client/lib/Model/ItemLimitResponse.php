...
/**
 * ItemLimitResponse Class Doc Comment
 *
 * @category Class
 ...
 */
class ItemLimitResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'item-limit-response';
    ...
    protected static $openAPITypes = [
        'per_user' => '\OpenAPI\Client\Model\ItemLimitResponsePerUser',
        'per_item' => '\OpenAPI\Client\Model\ItemLimitResponsePerItem',
        'recurrent_schedule' => '\OpenAPI\Client\Model\RecurrentScheduleResponse'
    ];
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('per_item', $data ?? [], null);
    ...
    */
     ...
     * Gets per_user
     *
     * @return \OpenAPI\Client\Model\ItemLimitResponsePerUser|null
     */
     ...
     * Sets per_user
     *
     * @param \OpenAPI\Client\Model\ItemLimitResponsePerUser|null $per_user per_user
     *
     * @return self
     */
    ...
    {
        if (is_null($per_user)) {
            array_push($this->openAPINullablesSetToNull, 'per_user');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('per_user', $nullablesSetToNull);
            if ($index !== FALSE) {
     ...
     * Gets per_item
     *
     * @return \OpenAPI\Client\Model\ItemLimitResponsePerItem|null
     */
     ...
     * Sets per_item
     *
     * @param \OpenAPI\Client\Model\ItemLimitResponsePerItem|null $per_item per_item
     *
     * @return self
     */
    ...
    {
        if (is_null($per_item)) {
            array_push($this->openAPINullablesSetToNull, 'per_item');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('per_item', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
     ...
     *
     * @return \OpenAPI\Client\Model\RecurrentScheduleResponse|null
     */
     ...
     *
     * @param \OpenAPI\Client\Model\RecurrentScheduleResponse|null $recurrent_schedule recurrent_schedule
     *
     * @return self
     */
