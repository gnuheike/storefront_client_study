...
/**
 * UserLimitItemPerUser Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class UserLimitItemPerUser implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'User_limit_item_per_user';
    ...
    */
     ...
     * Sets total
     *
     * @param int|null $total The maximum number of items a user can buy.
     *
     * @return self
     */
     ...
     * Sets available
     *
     * @param int|null $available The remaining number of items available for the user to purchase.
     *
     * @return self
     */
