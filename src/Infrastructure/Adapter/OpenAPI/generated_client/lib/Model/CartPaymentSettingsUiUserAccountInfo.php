...
/**
 * CartPaymentSettingsUiUserAccountInfo Class Doc Comment
 *
 * @category Class
 ...
 */
class CartPaymentSettingsUiUserAccountInfo implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Cart_Payment_settings_ui_user_account_info';
    ...
    */
    ...
    public function setOrder($order)
    {
        ...
        if (($order < 1)) {
            throw new \InvalidArgumentException('invalid value for $order when calling CartPaymentSettingsUiUserAccountInfo., must be bigger than or equal to 1.');
        }
