...
/**
 * UserAttributeConditionsResponseNumberInner Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class UserAttributeConditionsResponseNumberInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'user_attribute_conditions_response_number_inner';
    ...
    protected static $openAPITypes = [
        'attribute' => 'string',
        'type' => '\OpenAPI\Client\Model\UserAttributeConditionsPropertiesTypeNumber',
        'operator' => '\OpenAPI\Client\Model\UserAttributeConditionsPropertiesOperator',
        'value' => 'string',
        'can_be_missing' => 'bool'
    ];
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['attribute']) && (mb_strlen($this->container['attribute']) > 255)) {
            $invalidProperties[] = "invalid value for 'attribute', the character length must be smaller than or equal to 255.";
        }

        if (!is_null($this->container['attribute']) && (mb_strlen($this->container['attribute']) < 1)) {
            $invalidProperties[] = "invalid value for 'attribute', the character length must be bigger than or equal to 1.";
        }

        if (!is_null($this->container['attribute']) && !preg_match("/^[-_.\\d\\w]+$/", $this->container['attribute'])) {
     ...
     * Sets attribute
     *
     * @param string|null $attribute User attribute code.
     *
     * @return self
     */
    public function setAttribute($attribute)
    {
        ...
        if ((mb_strlen($attribute) > 255)) {
            throw new \InvalidArgumentException('invalid length for $attribute when calling UserAttributeConditionsResponseNumberInner., must be smaller than or equal to 255.');
        }
        if ((mb_strlen($attribute) < 1)) {
            throw new \InvalidArgumentException('invalid length for $attribute when calling UserAttributeConditionsResponseNumberInner., must be bigger than or equal to 1.');
        }
        if ((!preg_match("/^[-_.\\d\\w]+$/", ObjectSerializer::toString($attribute)))) {
            throw new \InvalidArgumentException("invalid value for \$attribute when calling UserAttributeConditionsResponseNumberInner., must conform to the pattern /^[-_.\\d\\w]+$/.");
        }
     ...
     * Gets type
     *
     * @return \OpenAPI\Client\Model\UserAttributeConditionsPropertiesTypeNumber|null
     */
     ...
     * Sets type
     *
     * @param \OpenAPI\Client\Model\UserAttributeConditionsPropertiesTypeNumber|null $type type
     *
     * @return self
     */
     ...
     * Gets operator
     *
     * @return \OpenAPI\Client\Model\UserAttributeConditionsPropertiesOperator|null
     */
     ...
     * Sets operator
     *
     * @param \OpenAPI\Client\Model\UserAttributeConditionsPropertiesOperator|null $operator operator
     *
     * @return self
     */
     ...
     * Sets value
     *
     * @param string|null $value Condition value which user attribute value will be compared to. Type depends on attribute type.
     *
     * @return self
     */
    public function setValue($value)
    {
        ...
        if ((mb_strlen($value) > 255)) {
            throw new \InvalidArgumentException('invalid length for $value when calling UserAttributeConditionsResponseNumberInner., must be smaller than or equal to 255.');
        }
