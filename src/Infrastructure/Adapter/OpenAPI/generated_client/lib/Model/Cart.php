...
class Cart implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'country' => 'string',
        'currency' => 'string',
        'items' => '\OpenAPI\Client\Model\CartAdminPaymentItemsInner[]'
    ];
    ...
    */
    ...
    public function setCountry($country)
    {
        ...
        if ((mb_strlen($country) > 2)) {
            throw new \InvalidArgumentException('invalid length for $country when calling Cart., must be smaller than or equal to 2.');
        }
        if ((mb_strlen($country) < 2)) {
            throw new \InvalidArgumentException('invalid length for $country when calling Cart., must be bigger than or equal to 2.');
        }
     ...
     * Sets currency
     *
     * @param string|null $currency The item price currency displayed in the cart. Three-letter code per [ISO 4217](https://en.wikipedia.org/wiki/ISO_4217). Check the documentation for detailed information about [currencies supported by Xsolla](https://developers.xsolla.com/doc/pay-station/references/supported-currencies/).
     *
     * @return self
     */
    public function setCurrency($currency)
    {
        ...
        if ((mb_strlen($currency) > 3)) {
            throw new \InvalidArgumentException('invalid length for $currency when calling Cart., must be smaller than or equal to 3.');
        }
        if ((mb_strlen($currency) < 3)) {
            throw new \InvalidArgumentException('invalid length for $currency when calling Cart., must be bigger than or equal to 3.');
        }
     ...
     * Gets items
     *
     * @return \OpenAPI\Client\Model\CartAdminPaymentItemsInner[]
     */
     ...
     * Sets items
     *
     * @param \OpenAPI\Client\Model\CartAdminPaymentItemsInner[] $items items
     *
     * @return self
     */
    public function setItems($items)
    {
        ...
        if ((count($items) < 1)) {
            throw new \InvalidArgumentException('invalid length for $items when calling Cart., number of items must be greater than or equal to 1.');
        }
