<?php
/**
 * ImportItemsFromExternalFile201Response
 *
 * PHP version 8.1
 *
 * @category Class
...
/**
 * ImportItemsFromExternalFile201Response Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class ImportItemsFromExternalFile201Response implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'import_items_from_external_file_201_response';
    ...
    */
     ...
     * Sets import_id
     *
     * @param string|null $import_id Import operation ID. If you encounter difficulties importing the JSON file, report this ID to your Customer Success Manager or send an email to csm@xsolla.com.
     *
     * @return self
     */
