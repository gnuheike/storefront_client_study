...
/**
 * GenerateCouponCodes200Response Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class GenerateCouponCodes200Response implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'generate_coupon_codes_200_response';
    ...
    */
    ...
    public function setCount($count)
    {
        ...
        if (($count > 100000)) {
            throw new \InvalidArgumentException('invalid value for $count when calling GenerateCouponCodes200Response., must be smaller than or equal to 100000.');
        }
        if (($count < 1)) {
            throw new \InvalidArgumentException('invalid value for $count when calling GenerateCouponCodes200Response., must be bigger than or equal to 1.');
        }
