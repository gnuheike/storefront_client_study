<?php
/**
 * CartPaymentAdminUserRequestBodyPhone
 *
 * PHP version 8.1
 *
 * @category Class
...
/**
 * CartPaymentAdminUserRequestBodyPhone Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class CartPaymentAdminUserRequestBodyPhone implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Cart_Payment_admin_user_request_body_phone';
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('hidden', $data ?? [], true);
    }
    ...
    */
     ...
     * Sets allow_modify
     *
     * @param bool|null $allow_modify Whether or not user can change the phone in the payment UI. If `phone.value` is passed in the token, the value is `false` by default.
     *
     * @return self
     */
