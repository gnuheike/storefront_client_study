<?php
/**
 * InlineObject99ResultErrorsBySkuInner
 *
 * PHP version 8.1
 *
 * @category Class
...
/**
 * InlineObject99ResultErrorsBySkuInner Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class InlineObject99ResultErrorsBySkuInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'inline_object_99_result_errors_by_sku_inner';
    ...
    public const TYPE_VIRTUAL_CURRENCY_PACKAGES = 'virtual_currency_packages';
    ...
    public function getTypeAllowableValues()
    {
        return [
            ...
            self::TYPE_VIRTUAL_CURRENCY_PACKAGES,
            self::TYPE_BUNDLE,
        ];
    }
    ...
    */
     ...
     * Sets sku
     *
     * @param string|null $sku SKU of the imported item.
     *
     * @return self
     */
     ...
     * Sets error_code
     *
     * @param int|null $error_code The import error code for a specific item SKU.
     *
     * @return self
     */
     ...
     * Sets error_message
     *
     * @param string|null $error_message The description of the import error for a specific item SKU.
     *
     * @return self
     */
