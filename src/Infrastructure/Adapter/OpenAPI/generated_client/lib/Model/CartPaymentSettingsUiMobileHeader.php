<?php
/**
 * CartPaymentSettingsUiMobileHeader
 *
 * PHP version 8.1
 *
 * @category Class
...
/**
 * CartPaymentSettingsUiMobileHeader Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class CartPaymentSettingsUiMobileHeader implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Cart_Payment_settings_ui_mobile_header';
    ...
    */
     ...
     * Sets close_button
     *
     * @param bool|null $close_button Whether to show a **Close** button in mobile payment UI. The button closes the payment UI and redirects the user to the URL specified in the `settings.return_url` parameter.
     *
     * @return self
     */
