...
/**
 * CreateOrderWithItemForVirtualCurrencyRequest Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class CreateOrderWithItemForVirtualCurrencyRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'create_order_with_item_for_virtual_currency_request';
    ...
    */
    ...
    public function setCustomParameters($custom_parameters)
    {
        ...
        if (!is_null($custom_parameters) && (count($custom_parameters) > 200)) {
            throw new \InvalidArgumentException('invalid value for $custom_parameters when calling CreateOrderWithItemForVirtualCurrencyRequest., number of items must be less than or equal to 200.');
        }
        if (!is_null($custom_parameters) && (count($custom_parameters) < 1)) {
            throw new \InvalidArgumentException('invalid length for $custom_parameters when calling CreateOrderWithItemForVirtualCurrencyRequest., number of items must be greater than or equal to 1.');
        }
