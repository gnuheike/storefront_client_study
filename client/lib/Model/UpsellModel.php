 ...
 */
class UpsellModel implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Upsell-model';
    ...
    */
     ...
     * Sets items
     *
     * @param string[] $items Array of items SKU.
     *
     * @return self
     */
