    ...
    */
    ...
    public function setExternalId($external_id)
    {
        ...
        if ((mb_strlen($external_id) > 255)) {
            throw new \InvalidArgumentException('invalid length for $external_id when calling InlineObject4., must be smaller than or equal to 255.');
        }
        if ((mb_strlen($external_id) < 1)) {
            throw new \InvalidArgumentException('invalid length for $external_id when calling InlineObject4., must be bigger than or equal to 1.');
        }
        if ((!preg_match("/^[-_.\\d\\w]+$/", ObjectSerializer::toString($external_id)))) {
            throw new \InvalidArgumentException("invalid value for \$external_id when calling InlineObject4., must conform to the pattern /^[-_.\\d\\w]+$/.");
        }
