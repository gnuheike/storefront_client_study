...
/**
 * CreateClanRewardChainModelAllOfValuePoint Class Doc Comment
 *
 * @category Class
 ...
 */
class CreateClanRewardChainModelAllOfValuePoint implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'create_clan_reward_chain_model_allOf_value_point';
    ...
    */
    ...
    public function setSku($sku)
    {
        ...
        if ((mb_strlen($sku) > 255)) {
            throw new \InvalidArgumentException('invalid length for $sku when calling CreateClanRewardChainModelAllOfValuePoint., must be smaller than or equal to 255.');
        }
        if ((mb_strlen($sku) < 1)) {
            throw new \InvalidArgumentException('invalid length for $sku when calling CreateClanRewardChainModelAllOfValuePoint., must be bigger than or equal to 1.');
        }
        if ((!preg_match("/^[a-zA-Z0-9_\\-–.]*$/", ObjectSerializer::toString($sku)))) {
            throw new \InvalidArgumentException("invalid value for \$sku when calling CreateClanRewardChainModelAllOfValuePoint., must conform to the pattern /^[a-zA-Z0-9_\\-–.]*$/.");
        }
