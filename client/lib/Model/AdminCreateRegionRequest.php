...
/**
 * AdminCreateRegionRequest Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class AdminCreateRegionRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'admin_create_region_request';
    ...
    */
     ...
     * Sets countries
     *
     * @param string[] $countries List of countries to be added in a region. <br>Two-letter uppercase country code per [ISO 3166-1 alpha-2](https://en.wikipedia.org/wiki/ISO_3166-1_alpha-2). Check the documentation for detailed information about [countries supported by Xsolla](https://developers.xsolla.com/doc/shop-builder/references/supported-countries/). <br>Example: `[\"JP\", \"CN\", \"VN\"]`
     *
     * @return self
     */
     ...
     * Sets name
     *
     * @param array<string,string> $name Name of region. Should contain key/value pairs where key is a locale with the \"^[a-z]{2}-[A-Z]{2}$\" format, the value is string.
     *
     * @return self
     */
