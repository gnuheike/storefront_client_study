...
/**
 * Promotions200PromoCodeBonusRewardItem Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class Promotions200PromoCodeBonusRewardItem implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Promotions_200_promo_code_bonus_reward_item';
    ...
    protected static $openAPITypes = [
        ...
        'description' => 'string',
        'image_url' => 'string',
        'unit_items' => '\OpenAPI\Client\Model\Promotions200PromoCodeBonusRewardItemUnitItemsInner[]'
    ];
    ...
    */
     ...
     * Gets unit_items
     *
     * @return \OpenAPI\Client\Model\Promotions200PromoCodeBonusRewardItemUnitItemsInner[]|null
     */
     ...
     * Sets unit_items
     *
     * @param \OpenAPI\Client\Model\Promotions200PromoCodeBonusRewardItemUnitItemsInner[]|null $unit_items If the item has the unit type, it includes all items in the unit. In the most cases the user should choose one of them as a promo code bonus.
     *
     * @return self
     */
