...
/**
 * ItemPeriodsResponseInner Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class ItemPeriodsResponseInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'item_periods_response_inner';
    ...
    */
     ...
     * Sets date_from
     *
     * @param \DateTime|null $date_from Date when the specified item will be available for sale.
     *
     * @return self
     */
     ...
     * Sets date_until
     *
     * @param \DateTime|null $date_until Date when the specified item will become unavailable for sale. Can be `null`.
     *
     * @return self
     */
