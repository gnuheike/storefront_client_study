...
/**
 * BundlesPricesInner Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class BundlesPricesInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Bundles_prices_inner';
    ...
    */
     ...
     * Sets amount
     *
     * @param string $amount Item price.
     *
     * @return self
     */
    public function setAmount($amount)
    {
        ...
        if ((!preg_match("/^\\d*\\.?\\d*$/", ObjectSerializer::toString($amount)))) {
            throw new \InvalidArgumentException("invalid value for \$amount when calling BundlesPricesInner., must conform to the pattern /^\\d*\\.?\\d*$/.");
        }
     ...
     * Sets is_default
     *
     * @param bool $is_default Default price is used to build a catalog if no price in the user's currency is specified.
     *
     * @return self
     */
     ...
     * Sets is_enabled
     *
     * @param bool $is_enabled The price is enabled.
     *
     * @return self
     */
