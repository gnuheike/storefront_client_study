...
/**
 * AdminPromotions200GetRedeemableCouponPromotionModelDiscountedItemsInnerDiscount Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class AdminPromotions200GetRedeemableCouponPromotionModelDiscountedItemsInnerDiscount implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'admin_promotions_200_get_redeemable_coupon_promotion_model_discounted_items_inner_discount';
    ...
    {
        $this->setIfExists('percent', $data ?? [], '10.00');
    }
    ...
    */
     ...
     * Sets percent
     *
     * @param string $percent Percent discount.  The price of cart item will be decreased using a value calculated by using this percent and then rounded to 2 decimal places.
     *
     * @return self
     */
