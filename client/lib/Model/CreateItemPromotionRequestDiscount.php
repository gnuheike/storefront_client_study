...
/**
 * CreateItemPromotionRequestDiscount Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class CreateItemPromotionRequestDiscount implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'create_item_promotion_request_discount';
    ...
    */
     ...
     * Sets percent
     *
     * @param string $percent Percent discount. The price of item will be decreased using a value calculated by using this percent and then rounded to 2 decimal places.
     *
     * @return self
     */
