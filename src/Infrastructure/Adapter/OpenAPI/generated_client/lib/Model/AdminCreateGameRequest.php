...
/**
 * AdminCreateGameRequest Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class AdminCreateGameRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'admin_create_game_request';
    ...
    protected static $openAPITypes = [
        ...
        'unit_items' => '\OpenAPI\Client\Model\AdminCreateGameRequestUnitItemsInner[]'
    ];
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['unit_items'] === null) {
            $invalidProperties[] = "'unit_items' can't be null";
        }
    ...
    public function setSku($sku)
    {
        ...
        if ((mb_strlen($sku) > 255)) {
            throw new \InvalidArgumentException('invalid length for $sku when calling AdminCreateGameRequest., must be smaller than or equal to 255.');
        }
        if ((mb_strlen($sku) < 1)) {
            throw new \InvalidArgumentException('invalid length for $sku when calling AdminCreateGameRequest., must be bigger than or equal to 1.');
        }
        if ((!preg_match("/^[a-zA-Z0-9_\\-–.]*$/", ObjectSerializer::toString($sku)))) {
            throw new \InvalidArgumentException("invalid value for \$sku when calling AdminCreateGameRequest., must conform to the pattern /^[a-zA-Z0-9_\\-–.]*$/.");
        }
     ...
     * Sets media_list
     *
     * @param \OpenAPI\Client\Model\AdminCreateGameRequestMediaListInner[]|null $media_list Game additional assets such as screenshots, gameplay video, etc.
     *
     * @return self
     */
    ...
    public function setAttributes($attributes)
    {
        ...
        if ((count($attributes) > 20)) {
            throw new \InvalidArgumentException('invalid value for $attributes when calling AdminCreateGameRequest., number of items must be less than or equal to 20.');
        }
     ...
     * Gets unit_items
     *
     * @return \OpenAPI\Client\Model\AdminCreateGameRequestUnitItemsInner[]
     */
     ...
     * Sets unit_items
     *
     * @param \OpenAPI\Client\Model\AdminCreateGameRequestUnitItemsInner[] $unit_items Game keys for different DRMs.
     *
     * @return self
     */
