...
/**
 * CatalogItemLimitsPerUser Class Doc Comment
 *
 * @category Class
 ...
 */
class CatalogItemLimitsPerUser implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Catalog_item_limits_per_user';
    ...
    protected static $openAPITypes = [
        'total' => 'int',
        'available' => 'int',
        'recurrent_schedule' => '\OpenAPI\Client\Model\CatalogItemLimitsPerUserRecurrentSchedule'
    ];
    ...
    */
     ...
     * Sets total
     *
     * @param int|null $total Total number of items a user can purchase. You can set this number in Publisher Account or use admin endpoints for Store entities (limits object).
     *
     * @return self
     */
     ...
     * Sets available
     *
     * @param int|null $available Available number of items for a user. The number decreases after every successful purchase. If no authorization is provided in the request,  the `available` number of items is set to match the `total` number of items.
     *
     * @return self
     */
     ...
     *
     * @return \OpenAPI\Client\Model\CatalogItemLimitsPerUserRecurrentSchedule|null
     */
     ...
     *
     * @param \OpenAPI\Client\Model\CatalogItemLimitsPerUserRecurrentSchedule|null $recurrent_schedule recurrent_schedule
     *
     * @return self
     */
    public function setRecurrentSchedule($recurrent_schedule)
    {
        if (is_null($recurrent_schedule)) {
            throw new \InvalidArgumentException('non-nullable recurrent_schedule cannot be null');
        }
