...
/**
 * PromotionsDiscountedItemsVerifyInnerDiscount Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class PromotionsDiscountedItemsVerifyInnerDiscount implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Promotions_discounted_items_verify_inner_discount';
    ...
    */
     ...
     * Sets percent
     *
     * @param string|null $percent Percent discount.  The price of cart item will be decreased using a value calculated by using this percent and then rounded to 2 decimal places.
     *
     * @return self
     */
