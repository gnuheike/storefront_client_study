<?php
/**
 * AdminCreateGameRequestUnitItemsInnerPricesInner
 *
 * PHP version 8.1
 *
 * @category Class
...
/**
 * AdminCreateGameRequestUnitItemsInnerPricesInner Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class AdminCreateGameRequestUnitItemsInnerPricesInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'admin_create_game_request_unit_items_inner_prices_inner';
    ...
    */
     ...
     * Sets is_default
     *
     * @param bool $is_default Default price is used to build catalog if no price in user's currency is specified.
     *
     * @return self
     */
