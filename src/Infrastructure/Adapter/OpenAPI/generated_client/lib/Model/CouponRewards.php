...
/**
 * CouponRewards Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class CouponRewards implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Coupon_rewards';
    ...
    */
     ...
     * Sets is_selectable
     *
     * @param bool|null $is_selectable If `true`, the user should select a bonus before redeeming a coupon.
     *
     * @return self
     */
