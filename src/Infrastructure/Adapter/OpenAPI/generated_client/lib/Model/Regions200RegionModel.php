...
/**
 * Regions200RegionModel Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class Regions200RegionModel implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Regions_200-region-model';
    ...
    */
     ...
     * Sets id
     *
     * @param int|null $id Region ID. Unique region identifier within the project.
     *
     * @return self
     */
     ...
     * Sets name
     *
     * @param array<string,string>|null $name Name of region. Should contain key/value pairs where key is a locale with the \"^[a-z]{2}-[A-Z]{2}$\" format, the value is string.
     *
     * @return self
     */
     ...
     * Sets countries
     *
     * @param string[]|null $countries List of countries to be added in a region. <br>Two-letter uppercase country code per [ISO 3166-1 alpha-2](https://en.wikipedia.org/wiki/ISO_3166-1_alpha-2). Check the documentation for detailed information about [countries supported by Xsolla](https://developers.xsolla.com/doc/shop-builder/references/supported-countries/). <br>Example: `[\"JP\", \"CN\", \"VN\"]`
     *
     * @return self
     */
