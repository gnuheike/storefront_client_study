<?php
/**
 * GetItemPromotion200ResponseDiscount
 *
 * PHP version 8.1
 *
 * @category Class
...
/**
 * GetItemPromotion200ResponseDiscount Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class GetItemPromotion200ResponseDiscount implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'get_item_promotion_200_response_discount';
    ...
    */
     ...
     * Sets percent
     *
     * @param string|null $percent Percent discount. The price of item will be decreased using a value which was calculated using this percent.
     *
     * @return self
     */
