...
/**
 * UserAttributeConditionsNumberInner Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class UserAttributeConditionsNumberInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'user_attribute_conditions_number_inner';
    ...
    */
    ...
    public function setAttribute($attribute)
    {
        ...
        if ((mb_strlen($attribute) > 255)) {
            throw new \InvalidArgumentException('invalid length for $attribute when calling UserAttributeConditionsNumberInner., must be smaller than or equal to 255.');
        }
        if ((mb_strlen($attribute) < 1)) {
            throw new \InvalidArgumentException('invalid length for $attribute when calling UserAttributeConditionsNumberInner., must be bigger than or equal to 1.');
        }
        if ((!preg_match("/^[-_.\\d\\w]+$/", ObjectSerializer::toString($attribute)))) {
            throw new \InvalidArgumentException("invalid value for \$attribute when calling UserAttributeConditionsNumberInner., must conform to the pattern /^[-_.\\d\\w]+$/.");
        }
     ...
     * Gets type
     *
     * @return \OpenAPI\Client\Model\UserAttributeConditionsPropertiesTypeNumber
     */
     ...
     * Sets type
     *
     * @param \OpenAPI\Client\Model\UserAttributeConditionsPropertiesTypeNumber $type type
     *
     * @return self
     */
     ...
     * Gets operator
     *
     * @return \OpenAPI\Client\Model\UserAttributeConditionsPropertiesOperator
     */
     ...
     * Sets operator
     *
     * @param \OpenAPI\Client\Model\UserAttributeConditionsPropertiesOperator $operator operator
     *
     * @return self
     */
    ...
    public function setValue($value)
    {
        ...
        if ((mb_strlen($value) > 255)) {
            throw new \InvalidArgumentException('invalid length for $value when calling UserAttributeConditionsNumberInner., must be smaller than or equal to 255.');
        }
