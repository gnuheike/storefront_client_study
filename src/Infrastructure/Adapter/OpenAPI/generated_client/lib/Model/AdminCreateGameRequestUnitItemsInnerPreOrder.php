<?php
/**
 * AdminCreateGameRequestUnitItemsInnerPreOrder
 *
 * PHP version 8.1
 *
 * @category Class
...
/**
 * AdminCreateGameRequestUnitItemsInnerPreOrder Class Doc Comment
 *
 * @category Class
 ...
 */
class AdminCreateGameRequestUnitItemsInnerPreOrder implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'admin_create_game_request_unit_items_inner_pre_order';
    ...
    */
     ...
     * Sets release_date
     *
     * @param string $release_date Game key release date in the ISO 8601 format.
     *
     * @return self
     */
     ...
     * Sets is_enabled
     *
     * @param bool $is_enabled If disabled, the item is not a pre-order.
     *
     * @return self
     */
     ...
     * Sets description
     *
     * @param string|null $description Additional information for the pre-order, which will be emailed.
     *
     * @return self
     */
