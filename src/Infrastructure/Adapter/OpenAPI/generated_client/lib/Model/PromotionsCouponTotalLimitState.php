<?php
/**
 * PromotionsCouponTotalLimitState
 *
 * PHP version 8.1
 *
 * @category Class
...
/**
 * PromotionsCouponTotalLimitState Class Doc Comment
 *
 * @category Class
 ...
 */
class PromotionsCouponTotalLimitState implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Promotions_coupon_total_limit_state';
    ...
    */
     ...
     * Sets available
     *
     * @param int|null $available The remaining number of times a coupon can be used.
     *
     * @return self
     */
     ...
     * Sets reserved
     *
     * @param int|null $reserved The reserved number of a coupon.
     *
     * @return self
     */
     ...
     * Sets used
     *
     * @param int|null $used The number of times a coupon is used.
     *
     * @return self
     */
