...
/**
 * CartPaymentAdminUserRequestBodyName Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class CartPaymentAdminUserRequestBodyName implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Cart_Payment_admin_user_request_body_name';
    ...
    */
     ...
     * Sets value
     *
     * @param string|null $value User screen name.
     *
     * @return self
     */
    public function setValue($value)
    {
        ...
        if ((mb_strlen($value) > 255)) {
            throw new \InvalidArgumentException('invalid length for $value when calling CartPaymentAdminUserRequestBodyName., must be smaller than or equal to 255.');
        }
        if ((mb_strlen($value) < 1)) {
            throw new \InvalidArgumentException('invalid length for $value when calling CartPaymentAdminUserRequestBodyName., must be bigger than or equal to 1.');
        }
