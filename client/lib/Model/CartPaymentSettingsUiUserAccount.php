<?php
/**
 * CartPaymentSettingsUiUserAccount
 *
 * PHP version 8.1
 *
 * @category Class
...
/**
 * CartPaymentSettingsUiUserAccount Class Doc Comment
 *
 * @category Class
 ...
 */
class CartPaymentSettingsUiUserAccount implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Cart_Payment_settings_ui_user_account';
    ...
    protected static $openAPITypes = [
        'payment_accounts' => '\OpenAPI\Client\Model\CartPaymentSettingsUiUserAccountPaymentAccounts',
        'info' => '\OpenAPI\Client\Model\CartPaymentSettingsUiUserAccountInfo',
        'subscriptions' => '\OpenAPI\Client\Model\CartPaymentSettingsUiUserAccountSubscriptions'
    ];
    ...
    */
     ...
     *
     * @return \OpenAPI\Client\Model\CartPaymentSettingsUiUserAccountPaymentAccounts|null
     */
     ...
     *
     * @param \OpenAPI\Client\Model\CartPaymentSettingsUiUserAccountPaymentAccounts|null $payment_accounts payment_accounts
     *
     * @return self
     */
    public function setPaymentAccounts($payment_accounts)
    {
        if (is_null($payment_accounts)) {
            throw new \InvalidArgumentException('non-nullable payment_accounts cannot be null');
        }
     ...
     * Gets info
     *
     * @return \OpenAPI\Client\Model\CartPaymentSettingsUiUserAccountInfo|null
     */
     ...
     * Sets info
     *
     * @param \OpenAPI\Client\Model\CartPaymentSettingsUiUserAccountInfo|null $info info
     *
     * @return self
     */
     ...
     * Gets subscriptions
     *
     * @return \OpenAPI\Client\Model\CartPaymentSettingsUiUserAccountSubscriptions|null
     */
     ...
     * Sets subscriptions
     *
     * @param \OpenAPI\Client\Model\CartPaymentSettingsUiUserAccountSubscriptions|null $subscriptions subscriptions
     *
     * @return self
     */
