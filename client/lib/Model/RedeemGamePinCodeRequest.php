...
/**
 * RedeemGamePinCodeRequest Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class RedeemGamePinCodeRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'redeem_game_pin_code_request';
    ...
    */
     ...
     * Sets sandbox
     *
     * @param bool|null $sandbox Redeem game code in the sandbox mode. The option is available for those users who are specified in the list of company users.
     *
     * @return self
     */
