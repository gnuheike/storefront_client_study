...
/**
 * AdminPromotions200GetRedeemableCouponPromotionModelDiscount Class Doc Comment
 *
 * @category Class
 ...
 */
class AdminPromotions200GetRedeemableCouponPromotionModelDiscount implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'admin_promotions_200_get_redeemable_coupon_promotion_model_discount';
    ...
    */
     ...
     * Sets percent
     *
     * @param string|null $percent Percent discount. The price of cart will be decreased using a value calculated by using this percent and then rounded to 2 decimal places.
     *
     * @return self
     */
