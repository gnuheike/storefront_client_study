...
/**
 * SetUserItemLimitRequest Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class SetUserItemLimitRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'set_user_item_limit_request';
    ...
    */
    ...
    public function setAvailable($available)
    {
        ...
        if (($available < 0)) {
            throw new \InvalidArgumentException('invalid value for $available when calling SetUserItemLimitRequest., must be bigger than or equal to 0.');
        }
