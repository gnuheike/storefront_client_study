...
/**
 * CartPaymentSettingsUiUserAccountSubscriptions Class Doc Comment
 *
 * @category Class
 ...
 */
class CartPaymentSettingsUiUserAccountSubscriptions implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Cart_Payment_settings_ui_user_account_subscriptions';
    ...
    */
     ...
     * Sets enable
     *
     * @param bool $enable Whether to show the submenu. `false` by default.
     *
     * @return self
     */
     ...
     * Sets order
     *
     * @param int $order Position of the submenu in the menu.
     *
     * @return self
     */
    public function setOrder($order)
    {
        ...
        if (($order < 1)) {
            throw new \InvalidArgumentException('invalid value for $order when calling CartPaymentSettingsUiUserAccountSubscriptions., must be bigger than or equal to 1.');
        }
