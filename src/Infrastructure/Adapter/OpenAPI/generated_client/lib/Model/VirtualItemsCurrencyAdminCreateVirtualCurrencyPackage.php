...
/**
 * VirtualItemsCurrencyAdminCreateVirtualCurrencyPackage Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class VirtualItemsCurrencyAdminCreateVirtualCurrencyPackage implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Virtual-Items-Currency_admin-create-virtual-currency-package';
    ...
    */
    ...
    public function setSku($sku)
    {
        ...
        if ((mb_strlen($sku) > 255)) {
            throw new \InvalidArgumentException('invalid length for $sku when calling VirtualItemsCurrencyAdminCreateVirtualCurrencyPackage., must be smaller than or equal to 255.');
        }
        if ((mb_strlen($sku) < 1)) {
            throw new \InvalidArgumentException('invalid length for $sku when calling VirtualItemsCurrencyAdminCreateVirtualCurrencyPackage., must be bigger than or equal to 1.');
        }
        if ((!preg_match("/^[a-zA-Z0-9_\\-–.]*$/", ObjectSerializer::toString($sku)))) {
            throw new \InvalidArgumentException("invalid value for \$sku when calling VirtualItemsCurrencyAdminCreateVirtualCurrencyPackage., must conform to the pattern /^[a-zA-Z0-9_\\-–.]*$/.");
        }
    ...
    public function setAttributes($attributes)
    {
        ...
        if ((count($attributes) > 20)) {
            throw new \InvalidArgumentException('invalid value for $attributes when calling VirtualItemsCurrencyAdminCreateVirtualCurrencyPackage., number of items must be less than or equal to 20.');
        }
     ...
     * Sets content
     *
     * @param object[] $content Virtual currency package should contain only 1 position of virtual currency.
     *
     * @return self
     */
