...
/**
 * VirtualItemsAdminPricesInner Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class VirtualItemsAdminPricesInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Virtual_Items_admin_prices_inner';
    ...
    */
    ...
    public function setAmount($amount)
    {
        ...
        if (($amount <= 0)) {
            throw new \InvalidArgumentException('invalid value for $amount when calling VirtualItemsAdminPricesInner., must be bigger than 0.');
        }
     ...
     * Sets country_iso
     *
     * @param string|null $country_iso Two-letter uppercase country code per [ISO 3166-1 alpha-2](https://en.wikipedia.org/wiki/ISO_3166-1_alpha-2). Check the documentation for detailed information about [countries supported by Xsolla](https://developers.xsolla.com/doc/shop-builder/references/supported-countries/). <br>Example: `country=US`
     *
     * @return self
     */
