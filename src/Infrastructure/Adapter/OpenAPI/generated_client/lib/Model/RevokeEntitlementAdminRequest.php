...
/**
 * RevokeEntitlementAdminRequest Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class RevokeEntitlementAdminRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'revoke_entitlement_admin_request';
    ...
    */
     ...
     * Sets mode
     *
     * @param string $mode What type of entitlements should be revoked. If the parameter is set to `sandbox`, the entitlement will be revoked from the user in the sandbox mode. If the parameter is set to `default`, the entitlement will be revoked from the user in the live mode.
     *
     * @return self
     */
