...
/**
 * PromotionsDiscountedItemsVerifyInner Class Doc Comment
 *
 * @category Class
 ...
 */
class PromotionsDiscountedItemsVerifyInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Promotions_discounted_items_verify_inner';
    ...
    protected static $openAPITypes = [
        ...
        'description' => 'string',
        'image_url' => 'string',
        'unit_items' => '\OpenAPI\Client\Model\PromotionsDiscountedItemsVerifyInnerUnitItemsInner[]',
        'discount' => '\OpenAPI\Client\Model\PromotionsDiscountedItemsVerifyInnerDiscount'
    ];
    ...
    */
     ...
     * Gets unit_items
     *
     * @return \OpenAPI\Client\Model\PromotionsDiscountedItemsVerifyInnerUnitItemsInner[]|null
     */
     ...
     * Sets unit_items
     *
     * @param \OpenAPI\Client\Model\PromotionsDiscountedItemsVerifyInnerUnitItemsInner[]|null $unit_items If the item has the unit type, it includes all items in the unit. In the most cases the user should choose one of them as a promo code bonus.
     *
     * @return self
     */
     ...
     * Gets discount
     *
     * @return \OpenAPI\Client\Model\PromotionsDiscountedItemsVerifyInnerDiscount|null
     */
     ...
     * Sets discount
     *
     * @param \OpenAPI\Client\Model\PromotionsDiscountedItemsVerifyInnerDiscount|null $discount discount
     *
     * @return self
     */
