...
/**
 * PriceConditionsItems Class Doc Comment
 *
 * @category Class
 ...
 */
class PriceConditionsItems implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'price_conditions_items';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if (!preg_match("/^\\d+(\\.\\d{1,4})?$/", $this->container['value'])) {
            $invalidProperties[] = "invalid value for 'value', must be conform to the pattern /^\\d+(\\.\\d{1,4})?$/.";
        }
     ...
     * Sets operator
     *
     * @param string $operator Comparison operator for setting the price range for applying the promotion.
     *
     * @return self
     */
     ...
     * Sets value
     *
     * @param string $value Value for determining the price range for applying the promotion.
     *
     * @return self
     */
    public function setValue($value)
    {
        ...
        if ((!preg_match("/^\\d+(\\.\\d{1,4})?$/", ObjectSerializer::toString($value)))) {
            throw new \InvalidArgumentException("invalid value for \$value when calling PriceConditionsItems., must conform to the pattern /^\\d+(\\.\\d{1,4})?$/.");
        }
