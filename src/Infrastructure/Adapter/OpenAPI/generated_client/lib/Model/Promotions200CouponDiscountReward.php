...
/**
 * Promotions200CouponDiscountReward Class Doc Comment
 *
 * @category Class
 * @description Percent discount. The price of cart will be decreased using a value calculated by using this percent and then rounded to 2 decimal places.
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class Promotions200CouponDiscountReward implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Promotions_200-coupon-discount-reward';
    ...
    */
     ...
     * Sets percent
     *
     * @param string|null $percent percent
     *
     * @return self
     */
