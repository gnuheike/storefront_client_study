<?php
/**
 * VirtualItemsCurrencyAdminPricesInner
 *
 * PHP version 8.1
 *
 * @category Class
...
/**
 * VirtualItemsCurrencyAdminPricesInner Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class VirtualItemsCurrencyAdminPricesInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Virtual_Items_Currency_admin_prices_inner';
    ...
    */
     ...
     * Sets currency
     *
     * @param string $currency Item price currency. Three-letter code per [ISO 4217](https://en.wikipedia.org/wiki/ISO_4217). Check the documentation for detailed information about [currencies supported by Xsolla](https://developers.xsolla.com/doc/pay-station/references/supported-currencies/).
     *
     * @return self
     */
    ...
    public function setAmount($amount)
    {
        ...
        if (($amount <= 0)) {
            throw new \InvalidArgumentException('invalid value for $amount when calling VirtualItemsCurrencyAdminPricesInner., must be bigger than 0.');
        }
