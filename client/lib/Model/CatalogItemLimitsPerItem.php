...
/**
 * CatalogItemLimitsPerItem Class Doc Comment
 *
 * @category Class
 ...
 */
class CatalogItemLimitsPerItem implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Catalog_item_limits_per_item';
    ...
    */
     ...
     * Sets total
     *
     * @param int|null $total Total number of items that can be purchased. You can set this number in Publisher Account or use admin endpoints for Store entities (limits object).
     *
     * @return self
     */
