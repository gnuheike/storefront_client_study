...
/**
 * InlineObject20OrdersInnerCouponsInner Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class InlineObject20OrdersInnerCouponsInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'inline_object_20_orders_inner_coupons_inner';
    ...
    public const TYPE_UNIQUE_CATALOG_OFFER = 'unique_catalog_offer';
    ...
    {
        return [
            self::TYPE_UNIQUE_CATALOG_OFFER,
            self::TYPE_COUPON,
            self::TYPE_PROMOCODE,
        ];
    }
    ...
    */
     ...
     * Sets coupon_id
     *
     * @param int|null $coupon_id Coupon ID, generated by Xsolla when creating a promotion with a coupon.
     *
     * @return self
     */
     ...
     * Sets sku
     *
     * @param string|null $sku Coupon SKU, generated by Xsolla when creating a promotion with a coupon.
     *
     * @return self
     */
     ...
     * Sets code
     *
     * @param string|null $code Used coupon code. Unique case-sensitive code. Contains letters and numbers.
     *
     * @return self
     */
     ...
     * Sets type
     *
     * @param string|null $type Type of coupon.
     *
     * @return self
     */
