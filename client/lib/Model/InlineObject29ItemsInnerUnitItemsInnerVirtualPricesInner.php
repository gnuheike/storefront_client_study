<?php
/**
 * InlineObject29ItemsInnerUnitItemsInnerVirtualPricesInner
 *
 * PHP version 8.1
 *
 * @category Class
...
/**
 * InlineObject29ItemsInnerUnitItemsInnerVirtualPricesInner Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class InlineObject29ItemsInnerUnitItemsInnerVirtualPricesInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'inline_object_29_items_inner_unit_items_inner_virtual_prices_inner';
    ...
    */
     ...
     * Sets name
     *
     * @param array<string,mixed>|null $name Object with localizations for virtual currency's name. Keys are specified in ISO 3166-1.
     *
     * @return self
     */
     ...
     * Sets type
     *
     * @param string|null $type Type of item. In this case it is always `virtual_currency`.
     *
     * @return self
     */
     ...
     * Sets description
     *
     * @param array<string,mixed>|null $description Object with localizations for game description. Keys are specified in ISO 3166-1.
     *
     * @return self
     */
