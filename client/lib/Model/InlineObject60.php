...
class InlineObject60 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'type' => 'string',
        'code' => 'string',
        'rewards' => '\OpenAPI\Client\Model\InlineObject60Rewards'
    ];
    ...
    */
     ...
     * Sets type
     *
     * @param string|null $type Type of code: `promocode`/`coupon`.
     *
     * @return self
     */
    ...
    public function setCode($code)
    {
        ...
        if ((mb_strlen($code) > 128)) {
            throw new \InvalidArgumentException('invalid length for $code when calling InlineObject60., must be smaller than or equal to 128.');
        }
        if ((mb_strlen($code) < 1)) {
            throw new \InvalidArgumentException('invalid length for $code when calling InlineObject60., must be bigger than or equal to 1.');
        }
        if ((!preg_match("/^[a-zA-Z0-9]+$/", ObjectSerializer::toString($code)))) {
            throw new \InvalidArgumentException("invalid value for \$code when calling InlineObject60., must conform to the pattern /^[a-zA-Z0-9]+$/.");
        }
     ...
     * Gets rewards
     *
     * @return \OpenAPI\Client\Model\InlineObject60Rewards|null
     */
     ...
     * Sets rewards
     *
     * @param \OpenAPI\Client\Model\InlineObject60Rewards|null $rewards rewards
     *
     * @return self
     */
