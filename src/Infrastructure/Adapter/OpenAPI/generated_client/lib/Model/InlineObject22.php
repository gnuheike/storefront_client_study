...
class InlineObject22 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'cart_id' => 'string',
        'price' => '\OpenAPI\Client\Model\InlineObject22Price',
        'is_free' => 'bool',
        'items' => '\OpenAPI\Client\Model\InlineObject22ItemsInner[]',
        'promotions' => '\OpenAPI\Client\Model\CatalogItemPromotionsInner[]',
        'warnings' => '\OpenAPI\Client\Model\InlineObject11WarningsInner[]'
    ];
    ...
    */
     ...
     * Sets cart_id
     *
     * @param string|null $cart_id Cart ID. Pass it to query for buy page or payment API endpoints.
     *
     * @return self
     */
     ...
     * Gets price
     *
     * @return \OpenAPI\Client\Model\InlineObject22Price|null
     */
     ...
     * Sets price
     *
     * @param \OpenAPI\Client\Model\InlineObject22Price|null $price price
     *
     * @return self
     */
     ...
     * Sets is_free
     *
     * @param bool|null $is_free If `true`, a cart is free.
     *
     * @return self
     */
     ...
     * Gets items
     *
     * @return \OpenAPI\Client\Model\InlineObject22ItemsInner[]|null
     */
     ...
     * Sets items
     *
     * @param \OpenAPI\Client\Model\InlineObject22ItemsInner[]|null $items items
     *
     * @return self
     */
     ...
     * Sets promotions
     *
     * @param \OpenAPI\Client\Model\CatalogItemPromotionsInner[]|null $promotions Applied promotions for the entire cart. The array is returned in the following cases:  * A promotion affects the total cart amount, such as a promo code with the **Discount on purchase setting**.  * A promotion adds bonus items to the cart.  If no order-level promotions are applied, an empty array is returned.
     *
     * @return self
     */
     ...
     * Gets warnings
     *
     * @return \OpenAPI\Client\Model\InlineObject11WarningsInner[]|null
     */
     ...
     * Sets warnings
     *
     * @param \OpenAPI\Client\Model\InlineObject11WarningsInner[]|null $warnings warnings
     *
     * @return self
     */
