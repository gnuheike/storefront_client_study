...
/**
 * Model422InvalidRequest Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class Model422InvalidRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = '422-invalid-request';
    ...
    */
     ...
     * Sets status_code
     *
     * @param float|null $status_code Response status code.
     *
     * @return self
     */
     ...
     * Sets error_code
     *
     * @param float|null $error_code Error code.
     *
     * @return self
     */
     ...
     * Sets error_message
     *
     * @param string|null $error_message Readable error message.
     *
     * @return self
     */
     ...
     * Sets transaction_id
     *
     * @param string|null $transaction_id Unique ID of request.
     *
     * @return self
     */
