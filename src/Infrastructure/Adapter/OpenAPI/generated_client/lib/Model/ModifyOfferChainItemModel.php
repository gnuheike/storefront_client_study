...
/**
 * ModifyOfferChainItemModel Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class ModifyOfferChainItemModel implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'modify-offer-chain-item-model';
    ...
    */
    ...
    public function setSku($sku)
    {
        ...
        if ((mb_strlen($sku) > 255)) {
            throw new \InvalidArgumentException('invalid length for $sku when calling ModifyOfferChainItemModel., must be smaller than or equal to 255.');
        }
        if ((mb_strlen($sku) < 1)) {
            throw new \InvalidArgumentException('invalid length for $sku when calling ModifyOfferChainItemModel., must be bigger than or equal to 1.');
        }
        if ((!preg_match("/^[a-zA-Z0-9_\\-–.]*$/", ObjectSerializer::toString($sku)))) {
            throw new \InvalidArgumentException("invalid value for \$sku when calling ModifyOfferChainItemModel., must conform to the pattern /^[a-zA-Z0-9_\\-–.]*$/.");
        }
     ...
     * Sets quantity
     *
     * @param int $quantity Reward item quantity for this chain step.
     *
     * @return self
     */
    public function setQuantity($quantity)
    {
        ...
        if (($quantity < 1)) {
            throw new \InvalidArgumentException('invalid value for $quantity when calling ModifyOfferChainItemModel., must be bigger than or equal to 1.');
        }
     ...
     * Sets order
     *
     * @param int|null $order Reward order for the offer chain step.
     *
     * @return self
     */
    public function setOrder($order)
    {
        ...
        if (!is_null($order) && ($order < 0)) {
            throw new \InvalidArgumentException('invalid value for $order when calling ModifyOfferChainItemModel., must be bigger than or equal to 0.');
        }
