...
/**
 * GenerateCouponCodesRequest Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class GenerateCouponCodesRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'generate_coupon_codes_request';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if (($this->container['count'] > 100000)) {
    ...
    public function setCount($count)
    {
        ...
        if (($count > 100000)) {
            throw new \InvalidArgumentException('invalid value for $count when calling GenerateCouponCodesRequest., must be smaller than or equal to 100000.');
        }
        if (($count < 1)) {
            throw new \InvalidArgumentException('invalid value for $count when calling GenerateCouponCodesRequest., must be bigger than or equal to 1.');
        }
