...
/**
 * VirtualItemsCurrencyAdminVirtualCurrencyPackage Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class VirtualItemsCurrencyAdminVirtualCurrencyPackage implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Virtual-Items-Currency_admin-virtual-currency-package';
    ...
    protected static $openAPITypes = [
        ...
        'is_enabled' => 'bool',
        'bundle_type' => 'string',
        'content' => '\OpenAPI\Client\Model\VirtualItemsCurrencyAdminVirtualCurrencyPackageContentInner[]',
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('bundle_type', $data ?? [], 'virtual_currency_package');
    ...
    */
    ...
    public function setSku($sku)
    {
        ...
        if ((mb_strlen($sku) > 255)) {
            throw new \InvalidArgumentException('invalid length for $sku when calling VirtualItemsCurrencyAdminVirtualCurrencyPackage., must be smaller than or equal to 255.');
        }
        if ((mb_strlen($sku) < 1)) {
            throw new \InvalidArgumentException('invalid length for $sku when calling VirtualItemsCurrencyAdminVirtualCurrencyPackage., must be bigger than or equal to 1.');
        }
        if ((!preg_match("/^[a-zA-Z0-9_\\-–.]*$/", ObjectSerializer::toString($sku)))) {
            throw new \InvalidArgumentException("invalid value for \$sku when calling VirtualItemsCurrencyAdminVirtualCurrencyPackage., must conform to the pattern /^[a-zA-Z0-9_\\-–.]*$/.");
        }
     ...
     * Gets content
     *
     * @return \OpenAPI\Client\Model\VirtualItemsCurrencyAdminVirtualCurrencyPackageContentInner[]|null
     */
     ...
     * Sets content
     *
     * @param \OpenAPI\Client\Model\VirtualItemsCurrencyAdminVirtualCurrencyPackageContentInner[]|null $content content
     *
     * @return self
     */
