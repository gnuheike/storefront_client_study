    ...
    */
    ...
    public function setExternalId($external_id)
    {
        ...
        if ((mb_strlen($external_id) > 255)) {
            throw new \InvalidArgumentException('invalid length for $external_id when calling InlineObject2., must be smaller than or equal to 255.');
        }
        if ((mb_strlen($external_id) < 1)) {
            throw new \InvalidArgumentException('invalid length for $external_id when calling InlineObject2., must be bigger than or equal to 1.');
        }
        if ((!preg_match("/^[a-zA-Z0-9-_]+$/", ObjectSerializer::toString($external_id)))) {
            throw new \InvalidArgumentException("invalid value for \$external_id when calling InlineObject2., must conform to the pattern /^[a-zA-Z0-9-_]+$/.");
        }
