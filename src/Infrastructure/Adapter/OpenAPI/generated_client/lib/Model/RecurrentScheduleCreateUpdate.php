...
/**
 * RecurrentScheduleCreateUpdate Class Doc Comment
 *
 * @category Class
 ...
 */
class RecurrentScheduleCreateUpdate implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'recurrent_schedule_create_update';
    ...
    */
     ...
     * Gets interval_type
     *
     * @return \OpenAPI\Client\Model\IntervalTypeMonthly
     */
     ...
     * Sets interval_type
     *
     * @param \OpenAPI\Client\Model\IntervalTypeMonthly $interval_type interval_type
     *
     * @return self
     */
     ...
     * Sets day_of_week
     *
     * @param int $day_of_week Day of the week when the reward chain is reset, where `1` is Monday and `7` is Sunday.
     *
     * @return self
     */
    public function setDayOfWeek($day_of_week)
    {
        ...
        if (($day_of_week > 7)) {
            throw new \InvalidArgumentException('invalid value for $day_of_week when calling RecurrentScheduleCreateUpdate., must be smaller than or equal to 7.');
        }
        if (($day_of_week < 1)) {
            throw new \InvalidArgumentException('invalid value for $day_of_week when calling RecurrentScheduleCreateUpdate., must be bigger than or equal to 1.');
        }
     ...
     * Sets time
     *
     * @param string $time Time when the reward chain is reset in the desired time zone (rounding to hours). <br><br> For example, the set time for the reward chain reset is 01:00 for the Kuala Lumpur time zone (GMT+8). In this case, the value of the `time` parameter is `01:00:00+08:00`.
     *
     * @return self
     */
    public function setTime($time)
    {
        ...
        if ((!preg_match("/((0[0-9]|1[0-9]|2[0-3]):00:00)(\\+|-)(0[0-9]|1[0-9]|2[0-3]):([0-5][0-9])/", ObjectSerializer::toString($time)))) {
            throw new \InvalidArgumentException("invalid value for \$time when calling RecurrentScheduleCreateUpdate., must conform to the pattern /((0[0-9]|1[0-9]|2[0-3]):00:00)(\\+|-)(0[0-9]|1[0-9]|2[0-3]):([0-5][0-9])/.");
        }
     ...
     * Sets day_of_month
     *
     * @param int $day_of_month Day of the month when the reward chain is reset. If the number of days in the month is less than the ordinal number of the specified day, then the reward chain reset occurs on the last day of the month.
     *
     * @return self
     */
    public function setDayOfMonth($day_of_month)
    {
        ...
        if (($day_of_month > 31)) {
            throw new \InvalidArgumentException('invalid value for $day_of_month when calling RecurrentScheduleCreateUpdate., must be smaller than or equal to 31.');
        }
        if (($day_of_month < 1)) {
            throw new \InvalidArgumentException('invalid value for $day_of_month when calling RecurrentScheduleCreateUpdate., must be bigger than or equal to 1.');
        }
