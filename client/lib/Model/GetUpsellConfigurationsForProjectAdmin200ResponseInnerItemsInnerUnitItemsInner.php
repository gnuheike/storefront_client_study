<?php
/**
 * GetUpsellConfigurationsForProjectAdmin200ResponseInnerItemsInnerUnitItemsInner
 *
 * PHP version 8.1
 *
 * @category Class
...
/**
 * GetUpsellConfigurationsForProjectAdmin200ResponseInnerItemsInnerUnitItemsInner Class Doc Comment
 *
 * @category Class
 ...
 */
class GetUpsellConfigurationsForProjectAdmin200ResponseInnerItemsInnerUnitItemsInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'get_upsell_configurations_for_project_admin_200_response_inner_items_inner_unit_items_inner';
    ...
    */
    ...
    public function setSku($sku)
    {
        ...
        if ((mb_strlen($sku) > 255)) {
            throw new \InvalidArgumentException('invalid length for $sku when calling GetUpsellConfigurationsForProjectAdmin200ResponseInnerItemsInnerUnitItemsInner., must be smaller than or equal to 255.');
        }
        if ((mb_strlen($sku) < 1)) {
            throw new \InvalidArgumentException('invalid length for $sku when calling GetUpsellConfigurationsForProjectAdmin200ResponseInnerItemsInnerUnitItemsInner., must be bigger than or equal to 1.');
        }
        if ((!preg_match("/^[a-zA-Z0-9_\\-–.]*$/", ObjectSerializer::toString($sku)))) {
            throw new \InvalidArgumentException("invalid value for \$sku when calling GetUpsellConfigurationsForProjectAdmin200ResponseInnerItemsInnerUnitItemsInner., must conform to the pattern /^[a-zA-Z0-9_\\-–.]*$/.");
        }
