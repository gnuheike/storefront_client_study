<?php
/**
 * BundlesAdminContentRequestInner
 *
 * PHP version 8.1
 *
 * @category Class
...
/**
 * BundlesAdminContentRequestInner Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class BundlesAdminContentRequestInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Bundles_admin_content_request_inner';
    ...
    */
    ...
    public function setSku($sku)
    {
        ...
        if ((mb_strlen($sku) > 255)) {
            throw new \InvalidArgumentException('invalid length for $sku when calling BundlesAdminContentRequestInner., must be smaller than or equal to 255.');
        }
        if ((mb_strlen($sku) < 1)) {
            throw new \InvalidArgumentException('invalid length for $sku when calling BundlesAdminContentRequestInner., must be bigger than or equal to 1.');
        }
        if ((!preg_match("/^[a-zA-Z0-9_\\-–.]*$/", ObjectSerializer::toString($sku)))) {
            throw new \InvalidArgumentException("invalid value for \$sku when calling BundlesAdminContentRequestInner., must conform to the pattern /^[a-zA-Z0-9_\\-–.]*$/.");
        }
     ...
     * Sets quantity
     *
     * @param int|null $quantity Quantity of the selected items in the bundle.
     *
     * @return self
     */
    public function setQuantity($quantity)
    {
        ...
        if (($quantity < 1)) {
            throw new \InvalidArgumentException('invalid value for $quantity when calling BundlesAdminContentRequestInner., must be bigger than or equal to 1.');
        }
