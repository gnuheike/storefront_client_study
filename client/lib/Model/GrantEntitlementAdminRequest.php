...
/**
 * GrantEntitlementAdminRequest Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class GrantEntitlementAdminRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'grant_entitlement_admin_request';
    ...
    protected static $openAPITypes = [
        ...
        'game' => '\OpenAPI\Client\Model\GrantEntitlementAdminRequestGame',
        'drm' => '\OpenAPI\Client\Model\GrantEntitlementAdminRequestDrm',
        'code' => 'string',
        'mode' => 'string',
        'user_country' => 'string'
    ];
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('user_country', $data ?? [], null);
    }
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['drm'] === null) {
            $invalidProperties[] = "'drm' can't be null";
        }
     ...
     *
     * @param string $user_external_id Unique user identifier.
     *
     * @return self
     */
     ...
     * Gets game
     *
     * @return \OpenAPI\Client\Model\GrantEntitlementAdminRequestGame
     */
     ...
     * Sets game
     *
     * @param \OpenAPI\Client\Model\GrantEntitlementAdminRequestGame $game game
     *
     * @return self
     */
     ...
     * Gets drm
     *
     * @return \OpenAPI\Client\Model\GrantEntitlementAdminRequestDrm
     */
     ...
     * Sets drm
     *
     * @param \OpenAPI\Client\Model\GrantEntitlementAdminRequestDrm $drm drm
     *
     * @return self
     */
     ...
     * Sets code
     *
     * @param string|null $code Game code of the game.
     *
     * @return self
     */
     ...
     * Sets mode
     *
     * @param string $mode What type of entitlements should be granted. If the parameter is set to `sandbox`, the entitlement will be granted to the user in the sandbox mode. If the parameter is set to `default`, the entitlement will be granted to the user in the live mode.
     *
     * @return self
     */
     ...
     * Sets user_country
     *
     * @param string|null $user_country User's country.
     *
     * @return self
     */
    public function setUserCountry($user_country)
    {
        if (is_null($user_country)) {
            array_push($this->openAPINullablesSetToNull, 'user_country');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('user_country', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
