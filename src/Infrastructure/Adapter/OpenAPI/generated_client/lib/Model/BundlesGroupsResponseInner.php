...
/**
 * BundlesGroupsResponseInner Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class BundlesGroupsResponseInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Bundles_groups_response_inner';
    ...
    */
     ...
     * Sets name
     *
     * @param array<string,string>|null $name Name of item. Should contain key/value pairs where key is a locale with \"^[a-z]{2}\" format, value is string.
     *
     * @return self
     */
