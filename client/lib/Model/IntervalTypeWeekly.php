...
/**
 * IntervalTypeWeekly Class Doc Comment
 *
 * @category Class
 ...
 */
class IntervalTypeWeekly implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'interval_type___weekly';
    ...
    */
    ...
    public function setDayOfWeek($day_of_week)
    {
        ...
        if (($day_of_week > 7)) {
            throw new \InvalidArgumentException('invalid value for $day_of_week when calling IntervalTypeWeekly., must be smaller than or equal to 7.');
        }
        if (($day_of_week < 1)) {
            throw new \InvalidArgumentException('invalid value for $day_of_week when calling IntervalTypeWeekly., must be bigger than or equal to 1.');
        }
    ...
    public function setTime($time)
    {
        ...
        if ((!preg_match("/((0[0-9]|1[0-9]|2[0-3]):00:00)(\\+|-)(0[0-9]|1[0-9]|2[0-3]):([0-5][0-9])/", ObjectSerializer::toString($time)))) {
            throw new \InvalidArgumentException("invalid value for \$time when calling IntervalTypeWeekly., must conform to the pattern /((0[0-9]|1[0-9]|2[0-3]):00:00)(\\+|-)(0[0-9]|1[0-9]|2[0-3]):([0-5][0-9])/.");
        }
