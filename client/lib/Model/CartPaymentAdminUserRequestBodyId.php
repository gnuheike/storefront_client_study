<?php
/**
 * CartPaymentAdminUserRequestBodyId
 *
 * PHP version 8.1
 *
 * @category Class
...
/**
 * CartPaymentAdminUserRequestBodyId Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class CartPaymentAdminUserRequestBodyId implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Cart_Payment_admin_user_request_body_id';
    ...
    */
     ...
     * Sets value
     *
     * @param string|null $value User ID. For testing, you can pass any value. To accept real payments, you need to use the user ID value from your system. This ID is passed in the [User validation](https://developers.xsolla.com/webhooks/operation/user-validation/) webhook.
     *
     * @return self
     */
    public function setValue($value)
    {
        ...
        if ((mb_strlen($value) > 255)) {
            throw new \InvalidArgumentException('invalid length for $value when calling CartPaymentAdminUserRequestBodyId., must be smaller than or equal to 255.');
        }
        if ((mb_strlen($value) < 1)) {
            throw new \InvalidArgumentException('invalid length for $value when calling CartPaymentAdminUserRequestBodyId., must be bigger than or equal to 1.');
        }
