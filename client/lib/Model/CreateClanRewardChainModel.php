...
/**
 * CreateClanRewardChainModel Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class CreateClanRewardChainModel implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'create-clan-reward-chain-model';
    ...
    protected static $openAPITypes = [
        ...
        'date_end' => '\DateTime',
        'is_enabled' => 'bool',
        'value_point' => '\OpenAPI\Client\Model\CreateClanRewardChainModelAllOfValuePoint',
        'steps' => '\OpenAPI\Client\Model\CreateRewardStep[]',
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['value_point'] === null) {
            $invalidProperties[] = "'value_point' can't be null";
        }
        if ($this->container['steps'] === null) {
            $invalidProperties[] = "'steps' can't be null";
        }
        if ($this->container['popup_header'] === null) {
            $invalidProperties[] = "'popup_header' can't be null";
        }
        if ($this->container['popup_instruction'] === null) {
            $invalidProperties[] = "'popup_instruction' can't be null";
        }
     ...
     * Gets value_point
     *
     * @return \OpenAPI\Client\Model\CreateClanRewardChainModelAllOfValuePoint
     */
     ...
     * Sets value_point
     *
     * @param \OpenAPI\Client\Model\CreateClanRewardChainModelAllOfValuePoint $value_point value_point
     *
     * @return self
     */
     ...
     * Gets steps
     *
     * @return \OpenAPI\Client\Model\CreateRewardStep[]
     */
     ...
     * Sets steps
     *
     * @param \OpenAPI\Client\Model\CreateRewardStep[] $steps steps
     *
     * @return self
     */
     ...
     * Gets popup_header
     *
     * @return \OpenAPI\Client\Model\PopupHeaderTwoLetterLocale
     */
     ...
     * Sets popup_header
     *
     * @param \OpenAPI\Client\Model\PopupHeaderTwoLetterLocale $popup_header popup_header
     *
     * @return self
     */
     ...
     *
     * @return \OpenAPI\Client\Model\PopupInstructionTwoLetterLocale
     */
     ...
     *
     * @param \OpenAPI\Client\Model\PopupInstructionTwoLetterLocale $popup_instruction popup_instruction
     *
     * @return self
     */
