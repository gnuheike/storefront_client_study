...
/**
 * RedeemPromoCodeRequestCart Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class RedeemPromoCodeRequestCart implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'redeem_promo_code_request_cart';
    ...
    {
        $this->setIfExists('id', $data ?? [], 'current');
    }
