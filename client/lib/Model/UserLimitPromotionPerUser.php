...
/**
 * UserLimitPromotionPerUser Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class UserLimitPromotionPerUser implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'User_limit_promotion_per_user';
    ...
    */
     ...
     * Sets total
     *
     * @param int|null $total The maximum number of times a user can use a promotion.
     *
     * @return self
     */
     ...
     * Sets available
     *
     * @param int|null $available The remaining number of times a user can use a promotion.
     *
     * @return self
     */
