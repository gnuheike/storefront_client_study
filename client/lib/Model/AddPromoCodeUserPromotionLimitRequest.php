<?php
/**
 * AddPromoCodeUserPromotionLimitRequest
 *
 * PHP version 8.1
 *
 * @category Class
...
/**
 * AddPromoCodeUserPromotionLimitRequest Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class AddPromoCodeUserPromotionLimitRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'add_promo_code_user_promotion_limit_request';
    ...
    protected static $openAPITypes = [
        'user' => '\OpenAPI\Client\Model\UserLimitUser',
        'available' => 'int'
    ];
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if (($this->container['available'] < 1)) {
            $invalidProperties[] = "invalid value for 'available', must be bigger than or equal to 1.";
        }
     ...
     * Gets user
     *
     * @return \OpenAPI\Client\Model\UserLimitUser
     */
     ...
     * Sets user
     *
     * @param \OpenAPI\Client\Model\UserLimitUser $user user
     *
     * @return self
     */
     ...
     * Sets available
     *
     * @param int $available Remaining number of the promo code uses available to the user within the limit applied.
     *
     * @return self
     */
    public function setAvailable($available)
    {
        ...
        if (($available < 1)) {
            throw new \InvalidArgumentException('invalid value for $available when calling AddPromoCodeUserPromotionLimitRequest., must be bigger than or equal to 1.');
        }
