...
/**
 * AddCouponUserPromotionLimitRequest Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class AddCouponUserPromotionLimitRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'add_coupon_user_promotion_limit_request';
    ...
    */
     ...
     * Sets available
     *
     * @param int $available Remaining number of the coupon uses available to the user within the limit applied.
     *
     * @return self
     */
    public function setAvailable($available)
    {
        ...
        if (($available < 1)) {
            throw new \InvalidArgumentException('invalid value for $available when calling AddCouponUserPromotionLimitRequest., must be bigger than or equal to 1.');
        }
