...
/**
 * UserLimitCouponPerUser Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class UserLimitCouponPerUser implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'User_limit_coupon_per_user';
    ...
    */
     ...
     * Sets total
     *
     * @param int|null $total The maximum number of times a user can use a coupon.
     *
     * @return self
     */
     ...
     * Sets available
     *
     * @param int|null $available The remaining number of times a user can use a coupon.
     *
     * @return self
     */
