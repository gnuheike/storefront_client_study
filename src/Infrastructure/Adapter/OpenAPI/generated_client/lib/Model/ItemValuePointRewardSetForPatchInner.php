<?php
/**
 * ItemValuePointRewardSetForPatchInner
 *
 * PHP version 8.1
 *
 * @category Class
...
/**
 * ItemValuePointRewardSetForPatchInner Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class ItemValuePointRewardSetForPatchInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'item_value_point_reward_set_for_patch_inner';
    ...
    */
    ...
    public function setSku($sku)
    {
        ...
        if ((mb_strlen($sku) > 255)) {
            throw new \InvalidArgumentException('invalid length for $sku when calling ItemValuePointRewardSetForPatchInner., must be smaller than or equal to 255.');
        }
        if ((mb_strlen($sku) < 1)) {
            throw new \InvalidArgumentException('invalid length for $sku when calling ItemValuePointRewardSetForPatchInner., must be bigger than or equal to 1.');
        }
        if ((!preg_match("/^[a-zA-Z0-9_\\-–.]*$/", ObjectSerializer::toString($sku)))) {
            throw new \InvalidArgumentException("invalid value for \$sku when calling ItemValuePointRewardSetForPatchInner., must conform to the pattern /^[a-zA-Z0-9_\\-–.]*$/.");
        }
     ...
     * Sets amount
     *
     * @param int $amount Amount of value points.
     *
     * @return self
     */
    public function setAmount($amount)
    {
        ...
        if (($amount < 0)) {
            throw new \InvalidArgumentException('invalid value for $amount when calling ItemValuePointRewardSetForPatchInner., must be bigger than or equal to 0.');
        }
