<?php
/**
 * AdminGetRewardChainItemFullModelValuePoint
 *
 * PHP version 8.1
 *
 * @category Class
...
/**
 * AdminGetRewardChainItemFullModelValuePoint Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class AdminGetRewardChainItemFullModelValuePoint implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'admin_get_reward_chain_item_full_model_value_point';
    ...
    */
    ...
    public function setSku($sku)
    {
        ...
        if ((mb_strlen($sku) > 255)) {
            throw new \InvalidArgumentException('invalid length for $sku when calling AdminGetRewardChainItemFullModelValuePoint., must be smaller than or equal to 255.');
        }
        if ((mb_strlen($sku) < 1)) {
            throw new \InvalidArgumentException('invalid length for $sku when calling AdminGetRewardChainItemFullModelValuePoint., must be bigger than or equal to 1.');
        }
        if ((!preg_match("/^[a-zA-Z0-9_\\-–.]*$/", ObjectSerializer::toString($sku)))) {
            throw new \InvalidArgumentException("invalid value for \$sku when calling AdminGetRewardChainItemFullModelValuePoint., must conform to the pattern /^[a-zA-Z0-9_\\-–.]*$/.");
        }
