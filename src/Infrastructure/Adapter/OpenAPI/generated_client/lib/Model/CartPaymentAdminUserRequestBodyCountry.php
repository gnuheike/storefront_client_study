...
/**
 * CartPaymentAdminUserRequestBodyCountry Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class CartPaymentAdminUserRequestBodyCountry implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Cart_Payment_admin_user_request_body_country';
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('allow_modify', $data ?? [], false);
    }
    ...
    */
     ...
     * Sets value
     *
     * @param string|null $value Two-letter uppercase country code per [ISO 3166-1 alpha-2](https://en.wikipedia.org/wiki/ISO_3166-1_alpha-2). Is required if an IP address is not passed in the `X-User-Ip` header. Check the documentation for detailed information about [countries supported by Xsolla](https://developers.xsolla.com/doc/shop-builder/references/supported-countries/). <br>Example: `country=US`
     *
     * @return self
     */
     ...
     * Sets allow_modify
     *
     * @param bool|null $allow_modify Whether or not user can change the country in payment UI.
     *
     * @return self
     */
