<?php
/**
 * VirtualItemsCurrencyAdminGetVcPricesInner
 *
 * PHP version 8.1
 *
 * @category Class
...
/**
 * VirtualItemsCurrencyAdminGetVcPricesInner Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class VirtualItemsCurrencyAdminGetVcPricesInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Virtual_Items_Currency_admin_get_vc_prices_inner';
    ...
    */
    ...
    public function setAmount($amount)
    {
        ...
        if (($amount <= 0)) {
            throw new \InvalidArgumentException('invalid value for $amount when calling VirtualItemsCurrencyAdminGetVcPricesInner., must be bigger than 0.');
        }
