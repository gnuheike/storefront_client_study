...
/**
 * CreateBonusPromotionRequest Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class CreateBonusPromotionRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'create_bonus_promotion_request';
    ...
    protected static $openAPITypes = [
        ...
        'condition' => '\OpenAPI\Client\Model\CreateBonusPromotionRequestConditionInner[]',
    ...
    */
     ...
     * Gets condition
     *
     * @return \OpenAPI\Client\Model\CreateBonusPromotionRequestConditionInner[]
     */
     ...
     * Sets condition
     *
     * @param \OpenAPI\Client\Model\CreateBonusPromotionRequestConditionInner[] $condition Set of items required to be included in the purchase for applying a promotion. If this parameters is `null`, a promotion will be applied to any purchases within a project.
     *
     * @return self
     */
     ...
     * Gets bonus
     *
     * @return \OpenAPI\Client\Model\CreateBonusPromotionRequestBonusInner[]
     */
     ...
     * Sets bonus
     *
     * @param \OpenAPI\Client\Model\CreateBonusPromotionRequestBonusInner[] $bonus bonus
     *
     * @return self
     */
     ...
     *
     * @param \OpenAPI\Client\Model\PriceConditionsItems[]|null $price_conditions Array of objects with conditions that set the price range for applying the promotion.<br> The promotion applies only to items whose price meets all the conditions in the array. If you pass this array, set the value of the [condition](/api/shop-builder/operation/create-bonus-promotion/#!path=condition&t=request) object to `null`.
     *
     * @return self
     */
